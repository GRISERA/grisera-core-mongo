...
class ModalityServiceMongoDB(ModalityService, GenericMongoServiceMixin):
    ...
    def save_modality(self, modality: ModalityIn, dataset_name: str):
        ...
        """
        return self.create(modality, dataset_name)
    ...
    def get_modality(
        self, modality_id: Union[int, str], dataset_name: str, depth: int = 0, source: str = ""
    ):
        """
        ...
        Returns:
            Result of request as modality object
        """
        return self.get_single(modality_id, dataset_name, depth, source)

    def _add_related_documents(self, modality: dict, dataset_name: str, depth: int, source: str):
