...
class ActivityExecutionConverter(BaseEntityConverter[ActivityExecutionIn]):
    ...
    def convert(self, json_entity: Dict[str, Any]) -> ActivityExecutionIn:
        ...
        print(f"📝 Creating ActivityExecutionIn: name='{clean_name_for_log}', activity_id='{activity_id}', arrangement_id='{arrangement_id}'{next_log}, scenario_exec_name='{scenario_execution_name}', external_id='{external_id}', properties={len(additional_properties)} (including common)")
