...
class RegisteredDataServiceMongoDB(RegisteredDataService, GenericMongoServiceMixin):
    ...
    def save_registered_data(self, registered_data: RegisteredDataIn, dataset_name: str):
        ...
        """
        return self.create(registered_data, dataset_name)
    ...
    def get_registered_data_nodes(self, dataset_name: str):
        ...
        """
        result_dict = self.get_multiple(dataset_name)
    ...
    def get_registered_data(
        self, registered_data_id: Union[str, int], dataset_name: str, depth: int = 0, source: str = ""
    ):
        """
        ...
        """
        return self.get_single(registered_data_id, dataset_name, depth, source)
    ...
    def update_registered_data(
        ...
        Returns:
            Result of request as registered data object
        """
        return self.update(registered_data_id, registered_data, dataset_name)
    ...
    def delete_registered_data(self, registered_data_id: Union[str, int],
        ...
        Returns:
            Result of request as registered data object
        """
        return self.delete(registered_data_id, dataset_name)

    def _add_related_documents(self, registered_data: dict, dataset_name: str, depth: int, source: str):
