...
class ObservableInformationServiceMongoDB(
    ...
    def save_observable_information(
        ...
        related_recording = self.recording_service.get_recording(
            observable_information.recording_id, dataset_name
        )
        ...
        return self.recording_service.add_observable_information(observable_information, dataset_name)
    ...
    def get_observable_informations(self, dataset_name: str):
        ...
        """
        observable_information_dicts = self.get_multiple(dataset_name)
        results = [
    ...
    def get_single_dict(
        ...
        self._add_related_documents(
            observable_information_dict, dataset_name, depth, source, related_recording
        )
    ...
    def get_observable_information(
        ...
        Returns:
            Result of request as observable information object
        """
        return self.get_single(observable_information_id, dataset_name, depth, source)

    def delete_observable_information(self, observable_information_id: Union[str, int], dataset_name: str):
        """
    ...
    def update_observable_information_relationships(
        ...
        Returns:
            Result of request as observable information object
        """
        existing_observable_information = self.get_observable_information(observable_information_id, dataset_name)
        ...
        return self.recording_service.update_observable_information(
            observable_information_id, existing_observable_information.dict(), dataset_name
        )
    ...
    def _add_related_documents(
        ...
        if depth > 0:
            self._add_related_time_series(observable_information, dataset_name, depth, source)
            self._add_related_modalities(observable_information, dataset_name, depth, source)
            self._add_related_life_activities(observable_information, dataset_name, depth, source)
            self._add_recording(observable_information, dataset_name, depth, source, recording)

    def _add_recording(
        self, observable_information: dict, dataset_name: str, depth: int, source: str, recording: dict
    ):
    ...
    def _add_related_modalities(
        self, observable_information: dict, dataset_name: str, depth: int, source: str
    ):
