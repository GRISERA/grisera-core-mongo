...
class LifeActivityServiceMongoDB(LifeActivityService, GenericMongoServiceMixin):
    ...
    def save_life_activity(self, life_activity: LifeActivityIn, dataset_name: str):
        ...
        """
        return self.create(life_activity, dataset_name)
    ...
    def get_life_activities(self, dataset_name: str):
        ...
        """
        result_dict = self.get_multiple(dataset_name=dataset_name)
    ...
    def get_life_activity(
        self, life_activity_id: Union[int, str], dataset_name: str, depth: int = 0, source: str = ""
    ):
        """
        ...
        Returns:
            Result of request as life activity object
        """
        return self.get_single(life_activity_id, dataset_name, depth, source)

    def _add_related_documents(self, life_activity: dict, dataset_name: str, depth: int, source: str):
