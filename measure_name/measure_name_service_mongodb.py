...
class MeasureNameServiceMongoDB(MeasureNameService, GenericMongoServiceMixin):
    ...
    def save_measure_name(self, measure_name: MeasureNameIn, dataset_name: str):
        ...
        """
        return self.create(measure_name, dataset_name)
    ...
    def get_measure_name(
        self, measure_name_id: Union[int, str], dataset_name: str, depth: int = 0, source: str = ""
    ):
        """
        ...
        Returns:
            Result of request as measure name object
        """
        return self.get_single(measure_name_id, dataset_name, depth, source)
    ...
    def delete_measure_name(self, measure_name_id: int, dataset_name: str):
        ...
        """
        return self.delete(measure_name_id, dataset_name)
    ...
    def update_measure_name(self, measure_name_id: int, measure_name: MeasureNameIn, dataset_name: str):
        ...
        Returns:
            Result of request as measure_name object
        """
        return self.update(measure_name_id, measure_name, dataset_name)

    def _add_related_documents(self, measure_name: dict, dataset_name: str, depth: int, source: str):
