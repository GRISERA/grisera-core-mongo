...
class TimeSeriesConverter(BaseEntityConverter[TimeSeriesIn]):
    ...
    def convert(self, json_entity: Dict[str, Any]) -> TimeSeriesIn:
        ...
        print(
            f"📝 Creating TimeSeriesIn for '{clean_entity_id_for_log}': measure_id='{measure_id}', obs_info_ids='{observable_information_ids}', type='{time_series_type}', source='{source}', external_id='{time_series.external_id}', import_job_id='{time_series.import_job_id}', properties={len(additional_properties)} (including common)")
